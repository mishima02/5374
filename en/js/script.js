...
var TrashModel = function(_lable, _cell, remarks) {
  ...
  for (var j in this.dayCell) {
    if (this.dayCell[j].length == 1) {
      ...
      result_text += "Every " + getWeekEN(this.dayCell[j]) + " ";
      ...
      //◇ result_text += "第" + this.dayCell[j].charAt(1) + this.dayCell[j].charAt(0) + "曜日 ";
        ...
        //◇第○曜日
        switch (this.dayCell[j].charAt(1)) {
          case "1":
            dsyu_text = "First";
            break;
          case "2":
        ...
        result_text += dsyu_text + "  " + getWeekEN(this.dayCell[j].charAt(0)) + "   ";
  ...
  this.getDateLabel = function() {
	...
	return this.getRemark() + "不明";
      ...
      var result_text = this.mostRecent.getFullYear() + "/" + (1 + this.mostRecent.getMonth()) + "/" + this.mostRecent.getDate() + ' (' + week_enum[this.mostRecent.getDay()] + ')';
...
/*   var descriptions = new Array(); */
  ...
  function createSelectBox () {
    ...
    var options_html = '<option value="-1" selected="selected">Please choose either North or South.</option>';
	  ...
	  if (trash.mostRecent === undefined) {
	    leftDayText == "不明";
            ...
            if (leftDay == 0) {
              ...
              leftDayText = leftDay + "Days later";
